...
<style>
    ...
    .wxm-crud-designer .designerPanel .component-icon, .wxm-crud-designer .designerPanel .component-icon:hover {
    ...
    .wxm-crud-designer .designerPanel .component-icon > i {
        display: none;

    }

    .wxm-crud-designer .designerPanel .component-icon > span {
        display: none;
    }
</style>
